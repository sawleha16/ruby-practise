RSpec.describe 'Nested Collections' do
  ...
  it 'test 13' do
   ...
   three_day_forecast = {days: [{high: 70,low: 63,summary: "Mostly Sunny"},{high: 55,low: 47,summary: "Partly Cloudy"},{high: 77,low: 64,summary: "Sunny"}],"date" => "6-21-18", ref_num: 3456789765456787656}
    ...
    three_day_forecast = {days: [{high: 70,low: 63,summary: "Mostly Sunny"},
                        ...
                        ref_num: 3456789765456787656}
    # Using the three_day_forecast variable defined above,
    # retrieve the expecte piece of information

    actual = three_day_forecast[:days][1].values().first
    expected = 55
    expect(actual).to eq(expected)
  end
  ...
  it 'test 16' do
   ...
   it 'test 17' do
    three_day_forecast = {days:
       [{high: 70,low: 63,summary: "Mostly Sunny"},{high: 55,low: 47,summary: "Partly Cloudy"},{high: 77,low: 64,summary: "Sunny"}],
        "date" => "6-21-18",
        ref_num: 3456789765456787656}
    # Using the three_day_forecast variable defined above,
    # retrieve the expected piece of information
  ...
  it 'test 18' do
    three_day_forecast = {
      days: [{high: 70,low: 63,summary: "Mostly Sunny"},{high: 55,low: 47,summary: "Partly Cloudy"},{high: 77,low: 64,summary: "Sunny"}],
       "date" => "6-21-18",
       ref_num: 3456789765456787656
     }
    # Using the three_day_forecast variable defined above,
  ...
  it 'test 19' do
    ...
    # Change the high on the first day to 99
     three_day_forecast[:days][0].update( "high":99)
  ...
  it 'test 20' do
   ...
   ref_num: 3456789765456787656}
    ...
    three_day_forecast.update("time" => '12:30')
